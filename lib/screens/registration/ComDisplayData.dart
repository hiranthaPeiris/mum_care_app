                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                'Competancy Registration Details',
                                style: TextStyle(
                                  fontSize: 20,
                              ...
                              child: Row(
                                children: <Widget>[
                                  Expanded(
                                    flex: 60,
                                    child: Text(
                                        'Have you got rubella imunization..? '),
                                  ),
                                  Expanded(
                                    flex: 20,
                                    child: Text('....................'),
                              ...
                              child: Row(
                                children: <Widget>[
                                  Expanded(
                                    flex: 60,
                                    child: Text(
                                        'Have you got formic acid in everyday..? '),
                                  ),
                                  Expanded(
                                    flex: 20,
                                    child: Text('....................'),

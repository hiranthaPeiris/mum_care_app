...
class _UpcomingHomeVisitFirebaseDemoState
                            ...
                            child: Column(
                              children: <Widget>[
                                InkWell(
                                  onTap: () {
                                    openBottomSheet(
                                        itemTitle, snapshot.data.docs[index]);
                                  },
                                  child: Stack(
  ...
  void openBottomSheet(String itemTitle, QueryDocumentSnapshot snap) {
    //get data with document reference
    DocumentReference dataRef = snap.data()['userDocRef'];
    print(dataRef);
    dataRef.get().then(((DocumentSnapshot documentSnapshot) {

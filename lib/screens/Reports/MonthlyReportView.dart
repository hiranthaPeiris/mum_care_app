...
class MonthlyReportView extends StatefulWidget {
  ...
  final DateTime getMonth;
  MonthlyReportView({Key key, this.getMonth}) : super(key: key);

  @override
  _MonthlyReportViewState createState() => new _MonthlyReportViewState();
}
